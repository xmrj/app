...
/**
 * Generated class for the CheckTaskAuditPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-check-task-audit',
  templateUrl: 'check-task-audit.html',
})
export class CheckTaskAuditPage {
  item: any;
  ...
  flowFlag:string = 'lims_b_test_task';// 流程标识
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CheckTaskAuditPage');
  }
